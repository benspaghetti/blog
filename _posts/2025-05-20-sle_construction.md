...
First, the non-self-crossing property is quite strong, which is why the simple random walk does not scale to a $\mathsf{SLE}$ but models of non-self-intersecting paths potentially do. For example, the loop-erased random walk ($\mathsf{SLE}\_{2}$) and the self avoiding walk ($\mathsf{SLE}\_{\frac{8}{3}}$) are two such models. 
